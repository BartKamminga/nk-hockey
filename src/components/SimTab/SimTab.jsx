...
export default function SimTab({ data, myTeam, effectiveComp, showForm }) {
  ...
  return (
    <div>
      <RemainingPouleCards data={data} showForm={showForm} pouleIds={timelinePouleIds} myTeam={myTeam} locks={locks}
